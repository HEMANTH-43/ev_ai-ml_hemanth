...
Objective: To develop a machine learning model that can predict the cost of an EV based on its specifications and performance metrics.
Dataset Information
File: raw_ev_dataset.csv
Cleaned File: cleaned_ev_data.csv
@@ -24,8 +18,5 @@ Major brands include Tesla, BMW, Hyundai, Kia, Ford, Nissan, Chevrolet, etc.
Feature Correlation
...
DATA LOADED, DATA CLEANED (PREPROCESSED) ,PERFORMED EDA ANALYSIS.
